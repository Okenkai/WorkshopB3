...
<body id="page-top">
    ...
    <div class="container">
        ...
        <header class="nu">
            <div class="container">
                <div class="nu-subheading">Trouver tout vos produits éco-responsable !</div>
                <div class="nu-heading text-uppercase">Les grands changements commencent avec des petits gestes !</div>
